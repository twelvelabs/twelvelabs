...
- [gostamp/docker-ubuntu](https://github.com/gostamp/docker-ubuntu) ([v0.2.1](https://github.com/gostamp/docker-ubuntu/releases/tag/v0.2.1), today) - Base devcontainer image
