...
- [envoyproxy/gateway](https://github.com/envoyproxy/gateway) ([v1.9.0-rc.1](https://github.com/envoyproxy/gateway/releases/tag/v1.9.0-rc.1), 3 days ago) - Manages Envoy Proxy as a Standalone or Kubernetes-based Application Gateway
...
- [lzhgus/Capso](https://github.com/lzhgus/Capso) - Open-source screenshot and screen recording for macOS. The free, native alternative to CleanShot X. Built with Swift 6.0 and SwiftUI. (2 days ago)
