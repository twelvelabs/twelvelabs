...
- [envoyproxy/gateway](https://github.com/envoyproxy/gateway) ([v1.5.2](https://github.com/envoyproxy/gateway/releases/tag/v1.5.2), today) - Manages Envoy Proxy as a Standalone or Kubernetes-based Application Gateway
...
- [go-enry/go-enry](https://github.com/go-enry/go-enry) - A faster file programming language detector (2 days ago)
- [yawn/offkey](https://github.com/yawn/offkey) - Print age encrypted small secrets for offline recovery (4 days ago)
