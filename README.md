...
- [envoyproxy/gateway](https://github.com/envoyproxy/gateway) ([v1.7.0](https://github.com/envoyproxy/gateway/releases/tag/v1.7.0), today) - Manages Envoy Proxy as a Standalone or Kubernetes-based Application Gateway
