...
- [hashicorp/go-getter](https://github.com/hashicorp/go-getter) ([v1.7.0](https://github.com/hashicorp/go-getter/releases/tag/v1.7.0), today) - Package for downloading things from a string URL using a variety of protocols.
