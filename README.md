...
- [go-task/task](https://github.com/go-task/task) ([v3.53.1](https://github.com/go-task/task/releases/tag/v3.53.1), today) - A fast, cross-platform build tool inspired by Make, designed for modern workflows.
- [envoyproxy/gateway](https://github.com/envoyproxy/gateway) ([v1.9.0](https://github.com/envoyproxy/gateway/releases/tag/v1.9.0), 3 days ago) - Manages Envoy Proxy as a Standalone or Kubernetes-based Application Gateway
