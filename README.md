...
- [go-task/task](https://github.com/go-task/task) ([v3.50.0](https://github.com/go-task/task/releases/tag/v3.50.0), 2 days ago) - A fast, cross-platform build tool inspired by Make, designed for modern workflows.
