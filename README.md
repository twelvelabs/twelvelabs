...
- [gostamp/docker-ubuntu](https://github.com/gostamp/docker-ubuntu) ([v0.1.0](https://github.com/gostamp/docker-ubuntu/releases/tag/v0.1.0), today) - Base devcontainer image
