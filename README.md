...
- [envoyproxy/gateway](https://github.com/envoyproxy/gateway) ([v1.8.3](https://github.com/envoyproxy/gateway/releases/tag/v1.8.3), 1 day ago) - Manages Envoy Proxy as a Standalone or Kubernetes-based Application Gateway
...
- [Gaurav-Gosain/tuitest](https://github.com/Gaurav-Gosain/tuitest) - Headless testing harness for terminal programs: real PTY, VT emulator, deterministic waits, and golden screen snapshots (4 days ago)
- [im2nguyen/rover](https://github.com/im2nguyen/rover) - Interactive Terraform visualization. State and configuration explorer. (6 days ago)
