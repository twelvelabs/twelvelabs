...
- [go-task/task](https://github.com/go-task/task) ([v3.46.2](https://github.com/go-task/task/releases/tag/v3.46.2), today) - A task runner / simpler Make alternative written in Go
- [envoyproxy/gateway](https://github.com/envoyproxy/gateway) ([v1.6.1](https://github.com/envoyproxy/gateway/releases/tag/v1.6.1), 1 week ago) - Manages Envoy Proxy as a Standalone or Kubernetes-based Application Gateway
