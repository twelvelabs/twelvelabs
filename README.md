...
- [cli/cli](https://github.com/cli/cli) ([v2.39.1](https://github.com/cli/cli/releases/tag/v2.39.1), 3 days ago) - GitHub’s official command line tool
- [abice/go-enum](https://github.com/abice/go-enum) ([v0.5.10](https://github.com/abice/go-enum/releases/tag/v0.5.10), 4 days ago) - An enum generator for go
...
- [airtai/faststream](https://github.com/airtai/faststream) - FastStream is a powerful and easy-to-use Python framework for building asynchronous services interacting with event streams such as Apache Kafka, RabbitMQ and NATS. (2 days ago)
