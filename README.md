...
- [gostamp/docker-golang](https://github.com/gostamp/docker-golang) ([v0.1.0](https://github.com/gostamp/docker-golang/releases/tag/v0.1.0), today) - Base devcontainer image for Go projects
