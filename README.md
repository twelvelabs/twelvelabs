...
- [envoyproxy/gateway](https://github.com/envoyproxy/gateway) ([v1.4.5](https://github.com/envoyproxy/gateway/releases/tag/v1.4.5), 6 days ago) - Manages Envoy Proxy as a Standalone or Kubernetes-based Application Gateway
- [twelvelabs/stamp](https://github.com/twelvelabs/stamp) ([v0.9.0](https://github.com/twelvelabs/stamp/releases/tag/v0.9.0), 6 days ago) - A project scaffolding tool written in Go
...
- [elisiariocouto/jsonschema-markdown](https://github.com/elisiariocouto/jsonschema-markdown) - 📖 Generate markdown documentation based on a JSON Schema document (today)
- [go-enry/go-enry](https://github.com/go-enry/go-enry) - A faster file programming language detector (3 weeks ago)
