...
- [go-task/task](https://github.com/go-task/task) ([v3.46.4](https://github.com/go-task/task/releases/tag/v3.46.4), 5 days ago) - A task runner / simpler Make alternative written in Go
...
- [jdx/usage](https://github.com/jdx/usage) - A specification for CLIs (4 weeks ago)
