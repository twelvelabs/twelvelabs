...
- [envoyproxy/gateway](https://github.com/envoyproxy/gateway) ([v1.6.5](https://github.com/envoyproxy/gateway/releases/tag/v1.6.5), 3 weeks ago) - Manages Envoy Proxy as a Standalone or Kubernetes-based Application Gateway
...
- [jacoscaz/taskparser](https://github.com/jacoscaz/taskparser) - A CLI tool to extract tasks and worklogs out of Markdown documents. (2 weeks ago)
- [aliev/baker](https://github.com/aliev/baker) - Baker is a command-line tool that helps you quickly scaffold new projects. It supports language-independent hooks for automating routine tasks. Baker is written in Rust and distributed as a standalone binary. (2 weeks ago)
