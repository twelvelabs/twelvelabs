...
- [gostamp/docker-golang](https://github.com/gostamp/docker-golang) - Base devcontainer image for Go projects (4 days ago)
...
- [cli/cli](https://github.com/cli/cli) ([v2.27.0](https://github.com/cli/cli/releases/tag/v2.27.0), 1 day ago) - GitHub’s official command line tool
- [gostamp/docker-golang](https://github.com/gostamp/docker-golang) ([v0.1.1](https://github.com/gostamp/docker-golang/releases/tag/v0.1.1), 4 days ago) - Base devcontainer image for Go projects
- [gostamp/docker-ubuntu](https://github.com/gostamp/docker-ubuntu) ([v0.4.0](https://github.com/gostamp/docker-ubuntu/releases/tag/v0.4.0), 6 days ago) - Base devcontainer image
- [twelvelabs/stylist](https://github.com/twelvelabs/stylist) ([v0.1.1](https://github.com/twelvelabs/stylist/releases/tag/v0.1.1), 1 week ago) - Manage all your code quality tools with a single executable
