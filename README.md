...
- [envoyproxy/gateway](https://github.com/envoyproxy/gateway) ([v1.5.5](https://github.com/envoyproxy/gateway/releases/tag/v1.5.5), today) - Manages Envoy Proxy as a Standalone or Kubernetes-based Application Gateway
