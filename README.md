...
- [envoyproxy/gateway](https://github.com/envoyproxy/gateway) ([v1.5.6](https://github.com/envoyproxy/gateway/releases/tag/v1.5.6), today) - Manages Envoy Proxy as a Standalone or Kubernetes-based Application Gateway
