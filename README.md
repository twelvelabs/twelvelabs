...
- [envoyproxy/gateway](https://github.com/envoyproxy/gateway) ([v1.5.8](https://github.com/envoyproxy/gateway/releases/tag/v1.5.8), today) - Manages Envoy Proxy as a Standalone or Kubernetes-based Application Gateway
