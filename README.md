...
- [envoyproxy/gateway](https://github.com/envoyproxy/gateway) ([v1.8.4](https://github.com/envoyproxy/gateway/releases/tag/v1.8.4), today) - Manages Envoy Proxy as a Standalone or Kubernetes-based Application Gateway
