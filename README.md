...
- [envoyproxy/gateway](https://github.com/envoyproxy/gateway) ([v1.5.5](https://github.com/envoyproxy/gateway/releases/tag/v1.5.5), 3 days ago) - Manages Envoy Proxy as a Standalone or Kubernetes-based Application Gateway
- [twelvelabs/stamp](https://github.com/twelvelabs/stamp) ([v0.9.0](https://github.com/twelvelabs/stamp/releases/tag/v0.9.0), 4 weeks ago) - A project scaffolding tool written in Go
...
- [elisiariocouto/jsonschema-markdown](https://github.com/elisiariocouto/jsonschema-markdown) - 📖 Generate markdown documentation based on a JSON Schema document (3 weeks ago)
