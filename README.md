...
- [go-task/task](https://github.com/go-task/task) ([nightly](https://github.com/go-task/task/releases/tag/nightly), 3 days ago) - A fast, cross-platform build tool inspired by Make, designed for modern workflows.
...
- [jdx/fnox](https://github.com/jdx/fnox) - encrypted/remote secret manager (2 months ago)
