...
- [envoyproxy/gateway](https://github.com/envoyproxy/gateway) ([v1.6.2](https://github.com/envoyproxy/gateway/releases/tag/v1.6.2), 2 days ago) - Manages Envoy Proxy as a Standalone or Kubernetes-based Application Gateway
- [go-task/task](https://github.com/go-task/task) ([v3.46.4](https://github.com/go-task/task/releases/tag/v3.46.4), 3 weeks ago) - A task runner / simpler Make alternative written in Go
